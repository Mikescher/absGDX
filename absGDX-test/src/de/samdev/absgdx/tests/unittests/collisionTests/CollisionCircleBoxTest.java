...
public class CollisionCircleBoxTest extends CollisionTest {

	@Parameters(name= "({1}|{2}) / {0}")
	public static Collection<Object[]> data() { return getParameters(); }
	
	public CollisionCircleBoxTest(int mapScale, int mapW, int mapH) {
    ...
    @Test
    public void testCircleBoxCollisionMovement_1D_X() {
    ...
    @Test
    public void testCircleBoxCollisionMovement_1D_Y() {
    	DummyGameLayer l = new DummyGameLayer(this.mapWidth, this.mapHeight, new DummyNoCollisionTileMap(this.mapWidth, this.mapHeight), this.expMapScale);
