...
public class ChessKing extends ChessPiece {
	...
	public List<Vector2i> getMoves() {
		...
		if (isValidMove(new Vector2i(00, +1), ChessMoveType.ANY)) moves.add(new Vector2i(00, +1));
		if (isValidMove(new Vector2i(+1, +1), ChessMoveType.ANY)) moves.add(new Vector2i(+1, +1));
		if (isValidMove(new Vector2i(+1, 00), ChessMoveType.ANY)) moves.add(new Vector2i(+1, 00));
		if (isValidMove(new Vector2i(+1, -1), ChessMoveType.ANY)) moves.add(new Vector2i(+1, -1));
		if (isValidMove(new Vector2i(00, -1), ChessMoveType.ANY)) moves.add(new Vector2i(00, -1));
		if (isValidMove(new Vector2i(-1, -1), ChessMoveType.ANY)) moves.add(new Vector2i(-1, -1));
		if (isValidMove(new Vector2i(-1, 00), ChessMoveType.ANY)) moves.add(new Vector2i(-1, 00));
